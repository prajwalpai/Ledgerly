  ...
  return (
    <div className="page dashboard-page">
      ...
      <section className="dashboard-grid">
        ...
        <article className="panel activity-panel"><div className="panel-heading"><div><p className="eyebrow">Latest</p><h2>Recent activity</h2></div><Link href="/transactions">View all</Link></div><div className="empty-list"><IndianRupee size={24} /><h3>No transactions yet</h3><p>Add an entry or import a statement to begin.</p></div></article>
