...
export function SettingsClient({ initialState }: { initialState: State }) {
  ...
  return <div className="page settings-page">
    ...
    <section className="settings-grid">
      ...
      <article className="panel settings-section"><div className="section-title"><div className="large-empty-icon drive"><FolderOpen size={23} /></div><div><h2>Google Drive sync</h2><p>Ledgerly Financial Inbox is connected through Google Drive for desktop.</p></div></div><dl className="status-list"><div><dt>Schedule</dt><dd className="ready">Daily at 8:00 AM</dd></div><div><dt>Timezone</dt><dd>Asia/Kolkata</dd></div><div><dt>OCR tools</dt><dd className="ready">Ready</dd></div></dl></article>
    </section>
